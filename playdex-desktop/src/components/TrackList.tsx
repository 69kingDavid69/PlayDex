...
export default function TrackList() {
  const { selectedPlaylist, queueSelectedPlaylist, engineStarted, downloadReady } = useDownloadStore()
    ...
    <div className="flex-1 flex flex-col overflow-hidden animate-fade-in">
      ...
      <div className="flex items-center justify-between px-6 py-4 border-b border-surface-700 shrink-0 bg-surface-800/40">
        ...
        <button 
          ...
          title={!engineStarted ? "Engine no iniciado" : !downloadReady ? "Falta ARL" : "Descargar playlist"}
        >
